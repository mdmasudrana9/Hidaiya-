...
exports.ZakatDonor = void 0;
const mongoose_1 = require("mongoose");
const ZakatDonorSchema = new mongoose_1.Schema({
    // id: {
    //   type: String,
...
ZakatDonorSchema.statics.isUserExits = function (id) {
    return __awaiter(this, void 0, void 0, function* () {
        const existhingUser = yield exports.ZakatDonor.findOne({ id });
...
//   return existhingUser
// }
exports.ZakatDonor = (0, mongoose_1.model)('ZakatDonor', ZakatDonorSchema);
